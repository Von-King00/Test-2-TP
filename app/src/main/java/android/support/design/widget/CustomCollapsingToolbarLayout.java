...
public class CustomCollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        handleInsetsAndOffsetChildren();
        updateTitleAndBounds(right, left, bottom, top);
        updateChildViewOffsetHelpers();
        updateToolbarMinimumHeight();
        updateScrimVisibility();
    }

    private void handleInsetsAndOffsetChildren() {
        if (mLastInsets != null) {
    ...
    private void updateTitleAndBounds(int right, int left, int bottom, int top) {
        if (mCollapsingTitleEnabled && mDummyView != null) {
    ...
    private void updateToolbarMinimumHeight() {
        if (mToolbar != null) {
